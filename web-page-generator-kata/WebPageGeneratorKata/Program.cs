...
users.Add(new User("Geraldine Rivia", "Redactora, editora y correctora con base en Madrid.\n\n" +
...
UsersStaticWebPageGenerator generator = new UsersStaticWebPageGenerator();
